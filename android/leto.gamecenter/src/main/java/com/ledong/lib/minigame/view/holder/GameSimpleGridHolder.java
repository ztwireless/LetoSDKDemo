...
public class GameSimpleGridHolder extends CommonViewHolder<GameCenterData_Game> {
	...
	public static GameSimpleGridHolder create(Context ctx, ViewGroup parent, IGameSwitchListener switchListener) {
		View view = View.inflate(ctx, MResource.getIdByName(ctx, "R.layout.leto_list_item_game_simple_grid"), null);
		return new GameSimpleGridHolder(view, switchListener);
	}

	public GameSimpleGridHolder(View view, IGameSwitchListener switchListener) {
